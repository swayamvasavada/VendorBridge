    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
      <label
        style={{
          fontSize: 11.5,
          fontWeight: 600,
          color: error ? t.error : t.textLabel,
...
export default function LoginPage() {
  ...
  if (typeof document !== "undefined") {
    if (!document.getElementById("procure-fonts")) {
      ...
      link.rel = "stylesheet";
      link.href =
        "https://fonts.googleapis.com/css2?family=Sora:wght@400;500;600;700;800&family=DM+Sans:ital,opsz,wght@0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700&display=swap";
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          width: "100%",
          maxWidth: 480, // slightly narrower container suitable for compact login pages
      ...
      >
        ...
        <p style={{ fontSize: 14, color: t.textMuted, marginBottom: 28 }}>
          Sign in to access your vendor portal dashboard
        </p>
          ...
          <Field label="Password" error={errors.password} t={t}>
            <TextInput
              ...
              rightEl={
                ...
                >
                  {showPwd ? (
                    <EyeSlash color={t.textMuted} />
                  ) : (
                    <EyeOpen color={t.textMuted} />
                  )}
                </button>
              }
            />
          ...
          >
            <div
              style={{
                ...
                border: `1.5px solid ${
                  fields.rememberMe ? t.accent : t.borderStrong
                }`,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
